...
export default function ProductSection() {
  ...
  const getProductForTab = (tab) => {
    if (tab === 'All') {
      ...
      setFilteredProducts(listOurProducts.filter(v => v.categoryDTO.categoryName === tab));
    }
  };
      ...
      <div className="container-fluid-lg">
        <div className="title title-flex-2">
          ...
          <div style={{
            ...
            <ul className="nav nav-tabs tab-style-color-2 tab-style-color" id="myTab" style={{ display: 'flex', flexWrap: 'nowrap' }}>
