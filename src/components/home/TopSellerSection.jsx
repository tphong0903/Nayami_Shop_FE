...
export default function TopSellerSection() {
  ...
  const getBestSellingByTime = (startDate, endDate) => {
    ...
    axios
      .get(
        `${import.meta.env.VITE_API_BASE_URL}/api/products/displayStatus/1`,
        {
        ...
        <div className="tab-content" id="myTabContent">
          ...
          >
            <div className="row g-8">
              {listProductsTopSelling && listProductsTopSelling.length > 0 ? (
                ...
                <div className="col-12 text-center my-4">
                  <p>
                    Không có sản phẩm bán chạy nào trong khoảng thời gian này
                  </p>
                </div>
              )}
            </div>
